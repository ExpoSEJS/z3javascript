 ...
 */
"use strict"; // The core of the node.js API for Z3. This file could be mostly autogenerated by Z3 scripts. Currently
...
var _refArray = _interopRequireDefault(require("ref-array"));

var _ffi = _interopRequireDefault(require("ffi"));
...
function _default(libPath) {
  ...
  var Void = _ref["default"].types["void"],
      Voidp = _ref["default"].refType(Void);
  ...
  var RCFNumObj = Voidp; // Names for standard types

  var CUInt = _ref["default"].types.uint32;
  var CInt = _ref["default"].types.int32;
  var CBool = _ref["default"].types.bool;
  var CFloat = _ref["default"].types["float"];
  var CULong = _ref["default"].types.uint64;
  var CLong = _ref["default"].types.int64;
  var CDouble = _ref["default"].types["double"];
  var CString = _ref["default"].types.CString; // Array types. Not all of these may be valid (check over time)

  var AstArray = (0, _refArray["default"])(Ast);
  var CIntArray = (0, _refArray["default"])(CInt);
  var CUIntArray = (0, _refArray["default"])(CUInt);
  var SymbolArray = (0, _refArray["default"])(_Symbol);
  var SortArray = (0, _refArray["default"])(_Symbol);
  var FuncDeclArray = (0, _refArray["default"])(FuncDecl);
  var ConstructorArray = (0, _refArray["default"])(Constructor);
  var ConstructorListArray = (0, _refArray["default"])(ConstructorList);
  var PatternArray = (0, _refArray["default"])(Pattern);
  var TacticObjArray = (0, _refArray["default"])(TacticObj);
  var RCFNumObjArray = (0, _refArray["default"])(RCFNumObj);
  ...
  GeneratedBindings['Z3_global_param_get'] = [CInt, [CString, _ref["default"].refType(CString)]];
  ...
  GeneratedBindings['Z3_params_set_bool'] = [Void, [ContextObj, Params, _Symbol, CInt]];
  GeneratedBindings['Z3_params_set_uint'] = [Void, [ContextObj, Params, _Symbol, CUInt]];
  GeneratedBindings['Z3_params_set_double'] = [Void, [ContextObj, Params, _Symbol, CDouble]];
  GeneratedBindings['Z3_params_set_symbol'] = [Void, [ContextObj, Params, _Symbol, _Symbol]];
  ...
  GeneratedBindings['Z3_param_descrs_get_kind'] = [CUInt, [ContextObj, ParamDescrs, _Symbol]];
  GeneratedBindings['Z3_param_descrs_size'] = [CUInt, [ContextObj, ParamDescrs]];
  GeneratedBindings['Z3_param_descrs_get_name'] = [_Symbol, [ContextObj, ParamDescrs, CUInt]];
  GeneratedBindings['Z3_param_descrs_get_documentation'] = [CString, [ContextObj, ParamDescrs, _Symbol]];
  GeneratedBindings['Z3_param_descrs_to_string'] = [CString, [ContextObj, ParamDescrs]];
  GeneratedBindings['Z3_mk_int_symbol'] = [_Symbol, [ContextObj, CInt]];
  GeneratedBindings['Z3_mk_string_symbol'] = [_Symbol, [ContextObj, CString]];
  GeneratedBindings['Z3_mk_uninterpreted_sort'] = [Sort, [ContextObj, _Symbol]];
  ...
  GeneratedBindings['Z3_mk_finite_domain_sort'] = [Sort, [ContextObj, _Symbol, CULong]];
  GeneratedBindings['Z3_mk_array_sort'] = [Sort, [ContextObj, Sort, Sort]];
  GeneratedBindings['Z3_mk_array_sort_n'] = [Sort, [ContextObj, CUInt, SortArray, Sort]];
  GeneratedBindings['Z3_mk_tuple_sort'] = [Sort, [ContextObj, _Symbol, CUInt, SymbolArray, SortArray, _ref["default"].refType(FuncDecl), FuncDeclArray]];
  GeneratedBindings['Z3_mk_enumeration_sort'] = [Sort, [ContextObj, _Symbol, CUInt, SymbolArray, FuncDeclArray, FuncDeclArray]];
  GeneratedBindings['Z3_mk_list_sort'] = [Sort, [ContextObj, _Symbol, Sort, _ref["default"].refType(FuncDecl), _ref["default"].refType(FuncDecl), _ref["default"].refType(FuncDecl), _ref["default"].refType(FuncDecl), _ref["default"].refType(FuncDecl), _ref["default"].refType(FuncDecl)]];
  GeneratedBindings['Z3_mk_constructor'] = [Constructor, [ContextObj, _Symbol, _Symbol, CUInt, SymbolArray, SortArray, CUIntArray]];
  GeneratedBindings['Z3_del_constructor'] = [Void, [ContextObj, Constructor]];
  GeneratedBindings['Z3_mk_datatype'] = [Sort, [ContextObj, _Symbol, CUInt, ConstructorArray]];
  ...
  GeneratedBindings['Z3_query_constructor'] = [Void, [ContextObj, Constructor, CUInt, _ref["default"].refType(FuncDecl), _ref["default"].refType(FuncDecl), FuncDeclArray]];
  GeneratedBindings['Z3_mk_func_decl'] = [FuncDecl, [ContextObj, _Symbol, CUInt, SortArray, Sort]];
  GeneratedBindings['Z3_mk_app'] = [Ast, [ContextObj, FuncDecl, CUInt, AstArray]];
  GeneratedBindings['Z3_mk_const'] = [Ast, [ContextObj, _Symbol, Sort]];
  ...
  GeneratedBindings['Z3_mk_rec_func_decl'] = [FuncDecl, [ContextObj, _Symbol, CUInt, SortArray, Sort]];
  GeneratedBindings['Z3_add_rec_def'] = [Void, [ContextObj, FuncDecl, CUInt, AstArray, Ast]];
  ...
  GeneratedBindings['Z3_mk_select_n'] = [Ast, [ContextObj, Ast, CUInt, AstArray]];
  GeneratedBindings['Z3_mk_store'] = [Ast, [ContextObj, Ast, Ast, Ast]];
  GeneratedBindings['Z3_mk_store_n'] = [Ast, [ContextObj, Ast, CUInt, AstArray, Ast]];
  ...
  GeneratedBindings['Z3_mk_as_array'] = [Ast, [ContextObj, FuncDecl]];
  GeneratedBindings['Z3_mk_set_has_size'] = [Ast, [ContextObj, Ast, Ast]];
  ...
  GeneratedBindings['Z3_mk_lstring'] = [Ast, [ContextObj, CUInt, CString]];
  ...
  GeneratedBindings['Z3_mk_seq_nth'] = [Ast, [ContextObj, Ast, Ast]];
  GeneratedBindings['Z3_mk_seq_length'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_mk_seq_index'] = [Ast, [ContextObj, Ast, Ast, Ast]];
  GeneratedBindings['Z3_mk_seq_last_index'] = [Ast, [ContextObj, Ast, Ast]];
  GeneratedBindings['Z3_mk_str_to_int'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_mk_int_to_str'] = [Ast, [ContextObj, Ast]];
  ...
  GeneratedBindings['Z3_mk_re_range'] = [Ast, [ContextObj, Ast, Ast]];
  GeneratedBindings['Z3_mk_re_loop'] = [Ast, [ContextObj, Ast, CUInt, CUInt]];
  GeneratedBindings['Z3_mk_re_intersect'] = [Ast, [ContextObj, CUInt, AstArray]];
  GeneratedBindings['Z3_mk_re_complement'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_mk_re_empty'] = [Ast, [ContextObj, Sort]];
  GeneratedBindings['Z3_mk_re_full'] = [Ast, [ContextObj, Sort]];
  GeneratedBindings['Z3_mk_linear_order'] = [FuncDecl, [ContextObj, Sort, CUInt]];
  GeneratedBindings['Z3_mk_partial_order'] = [FuncDecl, [ContextObj, Sort, CUInt]];
  GeneratedBindings['Z3_mk_piecewise_linear_order'] = [FuncDecl, [ContextObj, Sort, CUInt]];
  GeneratedBindings['Z3_mk_tree_order'] = [FuncDecl, [ContextObj, Sort, CUInt]];
  GeneratedBindings['Z3_mk_transitive_closure'] = [FuncDecl, [ContextObj, FuncDecl]];
  ...
  GeneratedBindings['Z3_mk_quantifier_ex'] = [Ast, [ContextObj, CInt, CUInt, _Symbol, _Symbol, CUInt, PatternArray, CUInt, AstArray, CUInt, SortArray, SymbolArray, Ast]];
  ...
  GeneratedBindings['Z3_mk_quantifier_const_ex'] = [Ast, [ContextObj, CInt, CUInt, _Symbol, _Symbol, CUInt, AstArray, CUInt, PatternArray, CUInt, AstArray, Ast]];
  GeneratedBindings['Z3_mk_lambda'] = [Ast, [ContextObj, CUInt, SortArray, SymbolArray, Ast]];
  GeneratedBindings['Z3_mk_lambda_const'] = [Ast, [ContextObj, CUInt, AstArray, Ast]];
  GeneratedBindings['Z3_get_symbol_kind'] = [CUInt, [ContextObj, _Symbol]];
  GeneratedBindings['Z3_get_symbol_int'] = [CInt, [ContextObj, _Symbol]];
  GeneratedBindings['Z3_get_symbol_string'] = [CString, [ContextObj, _Symbol]];
  GeneratedBindings['Z3_get_sort_name'] = [_Symbol, [ContextObj, Sort]];
  ...
  GeneratedBindings['Z3_get_finite_domain_sort_size'] = [CInt, [ContextObj, Sort, _ref["default"].refType(CULong)]];
  ...
  GeneratedBindings['Z3_mk_atleast'] = [Ast, [ContextObj, CUInt, AstArray, CUInt]];
  GeneratedBindings['Z3_mk_pble'] = [Ast, [ContextObj, CUInt, AstArray, CIntArray, CInt]];
  GeneratedBindings['Z3_mk_pbge'] = [Ast, [ContextObj, CUInt, AstArray, CIntArray, CInt]];
  GeneratedBindings['Z3_mk_pbeq'] = [Ast, [ContextObj, CUInt, AstArray, CIntArray, CInt]];
  ...
  GeneratedBindings['Z3_get_decl_name'] = [_Symbol, [ContextObj, FuncDecl]];
  ...
  GeneratedBindings['Z3_get_decl_symbol_parameter'] = [_Symbol, [ContextObj, FuncDecl, CUInt]];
  ...
  GeneratedBindings['Z3_get_numeral_double'] = [CDouble, [ContextObj, Ast]];
  GeneratedBindings['Z3_get_numerator'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_get_denominator'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_get_numeral_small'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CLong), _ref["default"].refType(CLong)]];
  GeneratedBindings['Z3_get_numeral_int'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CInt)]];
  GeneratedBindings['Z3_get_numeral_uint'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CUInt)]];
  GeneratedBindings['Z3_get_numeral_uint64'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CULong)]];
  GeneratedBindings['Z3_get_numeral_int64'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CLong)]];
  GeneratedBindings['Z3_get_numeral_rational_int64'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CLong), _ref["default"].refType(CLong)]];
  ...
  GeneratedBindings['Z3_is_quantifier_exists'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_is_lambda'] = [CInt, [ContextObj, Ast]];
  ...
  GeneratedBindings['Z3_get_quantifier_bound_name'] = [_Symbol, [ContextObj, Ast, CUInt]];
  ...
  GeneratedBindings['Z3_mk_model'] = [Model, [ContextObj]];
  GeneratedBindings['Z3_model_inc_ref'] = [Void, [ContextObj, Model]];
  GeneratedBindings['Z3_model_dec_ref'] = [Void, [ContextObj, Model]];
  GeneratedBindings['Z3_model_eval'] = [CInt, [ContextObj, Model, Ast, CInt, _ref["default"].refType(Ast)]];
  ...
  GeneratedBindings['Z3_model_translate'] = [Model, [ContextObj, Model, ContextObj]];
  GeneratedBindings['Z3_is_as_array'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_get_as_array_func_decl'] = [FuncDecl, [ContextObj, Ast]];
  GeneratedBindings['Z3_add_func_interp'] = [FuncInterpObj, [ContextObj, Model, FuncDecl, Ast]];
  GeneratedBindings['Z3_add_const_interp'] = [Void, [ContextObj, Model, FuncDecl, Ast]];
  ...
  GeneratedBindings['Z3_func_interp_set_else'] = [Void, [ContextObj, FuncInterpObj, Ast]];
  GeneratedBindings['Z3_func_interp_get_arity'] = [CUInt, [ContextObj, FuncInterpObj]];
  GeneratedBindings['Z3_func_interp_add_entry'] = [Void, [ContextObj, FuncInterpObj, AstVectorObj, Ast]];
  ...
  GeneratedBindings['Z3_parse_smtlib2_string'] = [AstVectorObj, [ContextObj, CString, CUInt, SymbolArray, SortArray, CUInt, SymbolArray, FuncDeclArray]];
  GeneratedBindings['Z3_parse_smtlib2_file'] = [AstVectorObj, [ContextObj, CString, CUInt, SymbolArray, SortArray, CUInt, SymbolArray, FuncDeclArray]];
  GeneratedBindings['Z3_eval_smtlib2_string'] = [CString, [ContextObj, CString]];
  ...
  GeneratedBindings['Z3_get_version'] = [Void, [_ref["default"].refType(CUInt), _ref["default"].refType(CUInt), _ref["default"].refType(CUInt), _ref["default"].refType(CUInt)]];
  GeneratedBindings['Z3_get_full_version'] = [CString, []];
  ...
  GeneratedBindings['Z3_goal_convert_model'] = [Model, [ContextObj, GoalObj, Model]];
  GeneratedBindings['Z3_goal_to_string'] = [CString, [ContextObj, GoalObj]];
  GeneratedBindings['Z3_goal_to_dimacs_string'] = [CString, [ContextObj, GoalObj]];
  ...
  GeneratedBindings['Z3_mk_solver_for_logic'] = [SolverObj, [ContextObj, _Symbol]];
  ...
  GeneratedBindings['Z3_solver_import_model_converter'] = [Void, [ContextObj, SolverObj, SolverObj]];
  ...
  GeneratedBindings['Z3_solver_from_file'] = [Void, [ContextObj, SolverObj, CString]];
  GeneratedBindings['Z3_solver_from_string'] = [Void, [ContextObj, SolverObj, CString]];
  GeneratedBindings['Z3_solver_get_assertions'] = [AstVectorObj, [ContextObj, SolverObj]];
  GeneratedBindings['Z3_solver_get_units'] = [AstVectorObj, [ContextObj, SolverObj]];
  GeneratedBindings['Z3_solver_get_trail'] = [AstVectorObj, [ContextObj, SolverObj]];
  GeneratedBindings['Z3_solver_get_non_units'] = [AstVectorObj, [ContextObj, SolverObj]];
  GeneratedBindings['Z3_solver_get_levels'] = [Void, [ContextObj, SolverObj, AstVectorObj, CUInt, CUIntArray]];
  GeneratedBindings['Z3_solver_set_activity'] = [Void, [ContextObj, SolverObj, Ast, CDouble]];
  ...
  GeneratedBindings['Z3_solver_get_consequences'] = [CInt, [ContextObj, SolverObj, AstVectorObj, AstVectorObj, AstVectorObj]];
  GeneratedBindings['Z3_solver_cube'] = [AstVectorObj, [ContextObj, SolverObj, AstVectorObj, CUInt]];
  ...
  GeneratedBindings['Z3_solver_to_dimacs_string'] = [CString, [ContextObj, SolverObj]];
  ...
  GeneratedBindings['Z3_rcf_get_numerator_denominator'] = [Void, [ContextObj, RCFNumObj, _ref["default"].refType(RCFNumObj), _ref["default"].refType(RCFNumObj)]];
  ...
  GeneratedBindings['Z3_fixedpoint_add_rule'] = [Void, [ContextObj, FixedpointObj, Ast, _Symbol]];
  ...
  GeneratedBindings['Z3_fixedpoint_update_rule'] = [Void, [ContextObj, FixedpointObj, Ast, _Symbol]];
  ...
  GeneratedBindings['Z3_optimize_assert_and_track'] = [Void, [ContextObj, OptimizeObj, Ast, Ast]];
  GeneratedBindings['Z3_optimize_assert_soft'] = [CUInt, [ContextObj, OptimizeObj, Ast, CString, _Symbol]];
  ...
  GeneratedBindings['Z3_optimize_check'] = [CInt, [ContextObj, OptimizeObj, CUInt, AstArray]];
  ...
  GeneratedBindings['Z3_optimize_get_unsat_core'] = [AstVectorObj, [ContextObj, OptimizeObj]];
  ...
  GeneratedBindings['Z3_optimize_get_lower_as_vector'] = [AstVectorObj, [ContextObj, OptimizeObj, CUInt]];
  GeneratedBindings['Z3_optimize_get_upper_as_vector'] = [AstVectorObj, [ContextObj, OptimizeObj, CUInt]];
  GeneratedBindings['Z3_optimize_to_string'] = [CString, [ContextObj, OptimizeObj]];
  GeneratedBindings['Z3_optimize_from_string'] = [Void, [ContextObj, OptimizeObj, CString]];
  GeneratedBindings['Z3_optimize_from_file'] = [Void, [ContextObj, OptimizeObj, CString]];
  ...
  GeneratedBindings['Z3_optimize_get_assertions'] = [AstVectorObj, [ContextObj, OptimizeObj]];
  GeneratedBindings['Z3_optimize_get_objectives'] = [AstVectorObj, [ContextObj, OptimizeObj]];
  ...
  GeneratedBindings['Z3_fpa_is_numeral_nan'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_is_numeral_inf'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_is_numeral_zero'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_is_numeral_normal'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_is_numeral_subnormal'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_is_numeral_positive'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_is_numeral_negative'] = [CInt, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_get_numeral_sign_bv'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_get_numeral_significand_bv'] = [Ast, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_get_numeral_sign'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CInt)]];
  GeneratedBindings['Z3_fpa_get_numeral_significand_string'] = [CString, [ContextObj, Ast]];
  GeneratedBindings['Z3_fpa_get_numeral_significand_uint64'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CULong)]];
  GeneratedBindings['Z3_fpa_get_numeral_exponent_string'] = [CString, [ContextObj, Ast, CInt]];
  GeneratedBindings['Z3_fpa_get_numeral_exponent_int64'] = [CInt, [ContextObj, Ast, _ref["default"].refType(CLong), CInt]];
  GeneratedBindings['Z3_fpa_get_numeral_exponent_bv'] = [Ast, [ContextObj, Ast, CInt]];
  ...
  GeneratedBindings['Z3_fixedpoint_query_from_lvl'] = [CInt, [ContextObj, FixedpointObj, Ast, CUInt]];
  GeneratedBindings['Z3_fixedpoint_get_ground_sat_answer'] = [Ast, [ContextObj, FixedpointObj]];
  GeneratedBindings['Z3_fixedpoint_get_rules_along_trace'] = [AstVectorObj, [ContextObj, FixedpointObj]];
  GeneratedBindings['Z3_fixedpoint_get_rule_names_along_trace'] = [_Symbol, [ContextObj, FixedpointObj]];
  GeneratedBindings['Z3_fixedpoint_add_invariant'] = [Void, [ContextObj, FixedpointObj, FuncDecl, Ast]];
  GeneratedBindings['Z3_fixedpoint_get_reachable'] = [Ast, [ContextObj, FixedpointObj, FuncDecl]];
  GeneratedBindings['Z3_qe_model_project'] = [Ast, [ContextObj, Model, CUInt, AstArray, Ast]];
  GeneratedBindings['Z3_qe_model_project_skolem'] = [Ast, [ContextObj, Model, CUInt, AstArray, Ast, AstMapObj]];
  GeneratedBindings['Z3_model_extrapolate'] = [Ast, [ContextObj, Model, Ast]];
  GeneratedBindings['Z3_qe_lite'] = [Ast, [ContextObj, AstVectorObj, Ast]];

  var Z3 = _ffi["default"].Library(libPath, GeneratedBindings);
  /**
      ...
      (function () {
        ...
        Z3[i] = function () {
          ...
          for (var _i = 0; _i < arguments.length; _i++) {
            new_args.push(unwrap(arguments[_i]));
          }
  ...
  Z3.bindings_model_eval = function (ctx, mdl, expr) {
    var pAST = _ref["default"].alloc(Z3.Ast, null);
  ...
  Z3.TRUE = 1;
  Z3.UNDEF = 0;
  Z3.FALSE = -1; // enum Z3_symbol_kind

  Z3.INT_SYMBOL = 0;
  Z3.STRING_SYMBOL = 1; // enum Z3_parameter_kind
  ...
  Z3.PARAMETER_AST = 5;
  Z3.PARAMETER_SORT = 4;
  Z3.PARAMETER_RATIONAL = 2; // enum Z3_sort_kind
  ...
  Z3.BOOL_SORT = 1;
  Z3.DATATYPE_SORT = 6;
  Z3.SEQ_SORT = 11; // enum  Z3_ast_kind
  ...
  Z3.SEARCH_TYPE = 11;
  Z3.REPLACE_ALL = 12;
  Z3.SUBSTRING = 13; // enum  Z3_ast_kind
  ...
  Z3.FUNC_DECL_AST = 5;
  Z3.NUMERAL_AST = 0;
  Z3.APP_AST = 1; // enum Z3_decl_kind
  ...
  Z3.OP_BCOMP = 1063;
  Z3.OP_RA_COMPLEMENT = 1546; // enum Z3_param_kind
  ...
  Z3.PK_UINT = 0;
  Z3.PK_STRING = 4;
  Z3.PK_DOUBLE = 2; // enum Z3_search_failure
  ...
  Z3.NO_FAILURE = 0;
  Z3.TIMEOUT = 2;
  Z3.NUM_CONFLICTS = 5; // enum Z3_ast_print_mode

  Z3.PRINT_SMTLIB2_COMPLIANT = 3;
  Z3.PRINT_SMTLIB_COMPLIANT = 2;
  Z3.PRINT_SMTLIB_FULL = 0;
  Z3.PRINT_LOW_LEVEL = 1; // enum Z3_error_code
  ...
  Z3.SORT_ERROR = 1;
  Z3.PARSER_ERROR = 4;
  Z3.DEC_REF_ERROR = 11; // enum Z3_goal_prec;

  Z3.GOAL_UNDER = 1;
  Z3.GOAL_PRECISE = 0;
  Z3.GOAL_UNDER_OVER = 3;
  Z3.GOAL_OVER = 2; /////// end constants
  //// Exported types

...
var _refArray = require('ref-array');
...
var libPath = _config2.default.Z3_DIR;
...
var Void = _ref2.default.types.void,
    Voidp = _ref2.default.refType(Void);
...
var CUInt = _ref2.default.types.uint32;
var CInt = _ref2.default.types.int32;
var CBool = _ref2.default.types.bool;
var CFloat = _ref2.default.types.float;
var CULong = _ref2.default.types.uint64;
var CLong = _ref2.default.types.int64;
var CDouble = _ref2.default.types.double;
var CString = _ref2.default.types.CString;

// Array types. Not all of these may be valid (check over time)
var AstArray = (0, _refArray2.default)(Ast);
var CIntArray = (0, _refArray2.default)(CInt);
var CUIntArray = (0, _refArray2.default)(CUInt);
var SymbolArray = (0, _refArray2.default)(_Symbol);
var SortArray = (0, _refArray2.default)(_Symbol);
var FuncDeclArray = (0, _refArray2.default)(FuncDecl);
var ConstructorArray = (0, _refArray2.default)(Constructor);
var ConstructorListArray = (0, _refArray2.default)(ConstructorList);
var PatternArray = (0, _refArray2.default)(Pattern);
var TacticObjArray = (0, _refArray2.default)(TacticObj);
var RCFNumObjArray = (0, _refArray2.default)(RCFNumObj);
...
GeneratedBindings['Z3_global_param_get'] = [CInt, [CString, _ref2.default.refType(CString)]];
...
GeneratedBindings['Z3_mk_tuple_sort'] = [Sort, [ContextObj, _Symbol, CUInt, SymbolArray, SortArray, _ref2.default.refType(FuncDecl), FuncDeclArray]];
GeneratedBindings['Z3_mk_enumeration_sort'] = [Sort, [ContextObj, _Symbol, CUInt, SymbolArray, FuncDeclArray, FuncDeclArray]];
GeneratedBindings['Z3_mk_list_sort'] = [Sort, [ContextObj, _Symbol, Sort, _ref2.default.refType(FuncDecl), _ref2.default.refType(FuncDecl), _ref2.default.refType(FuncDecl), _ref2.default.refType(FuncDecl), _ref2.default.refType(FuncDecl), _ref2.default.refType(FuncDecl)]];
...
GeneratedBindings['Z3_query_constructor'] = [Void, [ContextObj, Constructor, CUInt, _ref2.default.refType(FuncDecl), _ref2.default.refType(FuncDecl), FuncDeclArray]];
...
GeneratedBindings['Z3_get_finite_domain_sort_size'] = [CInt, [ContextObj, Sort, _ref2.default.refType(CULong)]];
...
GeneratedBindings['Z3_get_bool_value'] = [CUInt, [ContextObj, Ast]];
...
GeneratedBindings['Z3_get_numeral_small'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CLong), _ref2.default.refType(CLong)]];
GeneratedBindings['Z3_get_numeral_int'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CInt)]];
GeneratedBindings['Z3_get_numeral_uint'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CUInt)]];
GeneratedBindings['Z3_get_numeral_uint64'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CULong)]];
GeneratedBindings['Z3_get_numeral_int64'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CLong)]];
GeneratedBindings['Z3_get_numeral_rational_int64'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CLong), _ref2.default.refType(CLong)]];
...
GeneratedBindings['Z3_model_eval'] = [CInt, [ContextObj, Model, Ast, CInt, _ref2.default.refType(Ast)]];
...
GeneratedBindings['Z3_get_error_msg'] = [CString, [CUInt]];
GeneratedBindings['Z3_get_error_msg_ex'] = [CString, [ContextObj, CUInt]];
GeneratedBindings['Z3_get_version'] = [Void, [_ref2.default.refType(CUInt), _ref2.default.refType(CUInt), _ref2.default.refType(CUInt), _ref2.default.refType(CUInt)]];
...
GeneratedBindings['Z3_mk_injective_function'] = [FuncDecl, [ContextObj, _Symbol, CUInt, SortArray, Sort]];
GeneratedBindings['Z3_set_logic'] = [Void, [ContextObj, CString]];
GeneratedBindings['Z3_push'] = [Void, [ContextObj]];
GeneratedBindings['Z3_pop'] = [Void, [ContextObj, CUInt]];
GeneratedBindings['Z3_get_num_scopes'] = [CUInt, [ContextObj]];
GeneratedBindings['Z3_persist_ast'] = [Void, [ContextObj, Ast, CUInt]];
GeneratedBindings['Z3_assert_cnstr'] = [Void, [ContextObj, Ast]];
GeneratedBindings['Z3_check_and_get_model'] = [CInt, [ContextObj, _ref2.default.refType(Model)]];
GeneratedBindings['Z3_check'] = [CInt, [ContextObj]];
GeneratedBindings['Z3_check_assumptions'] = [CInt, [ContextObj, CUInt, AstArray, _ref2.default.refType(Model), _ref2.default.refType(Ast), _ref2.default.refType(CUInt), AstArray]];
GeneratedBindings['Z3_get_implied_equalities'] = [CUInt, [ContextObj, SolverObj, CUInt, AstArray, CUIntArray]];
GeneratedBindings['Z3_del_model'] = [Void, [ContextObj, Model]];
GeneratedBindings['Z3_soft_check_cancel'] = [Void, [ContextObj]];
GeneratedBindings['Z3_get_search_failure'] = [CUInt, [ContextObj]];
GeneratedBindings['Z3_mk_label'] = [Ast, [ContextObj, _Symbol, CInt, Ast]];
GeneratedBindings['Z3_get_relevant_labels'] = [Literals, [ContextObj]];
GeneratedBindings['Z3_get_relevant_literals'] = [Literals, [ContextObj]];
GeneratedBindings['Z3_get_guessed_literals'] = [Literals, [ContextObj]];
GeneratedBindings['Z3_del_literals'] = [Void, [ContextObj, Literals]];
GeneratedBindings['Z3_get_num_literals'] = [CUInt, [ContextObj, Literals]];
GeneratedBindings['Z3_get_label_symbol'] = [_Symbol, [ContextObj, Literals, CUInt]];
GeneratedBindings['Z3_get_literal'] = [Ast, [ContextObj, Literals, CUInt]];
GeneratedBindings['Z3_disable_literal'] = [Void, [ContextObj, Literals, CUInt]];
GeneratedBindings['Z3_block_literals'] = [Void, [ContextObj, Literals]];
GeneratedBindings['Z3_get_model_num_constants'] = [CUInt, [ContextObj, Model]];
GeneratedBindings['Z3_get_model_constant'] = [FuncDecl, [ContextObj, Model, CUInt]];
GeneratedBindings['Z3_get_model_num_funcs'] = [CUInt, [ContextObj, Model]];
GeneratedBindings['Z3_get_model_func_decl'] = [FuncDecl, [ContextObj, Model, CUInt]];
GeneratedBindings['Z3_eval_func_decl'] = [CInt, [ContextObj, Model, FuncDecl, _ref2.default.refType(Ast)]];
GeneratedBindings['Z3_is_array_value'] = [CInt, [ContextObj, Model, Ast, _ref2.default.refType(CUInt)]];
GeneratedBindings['Z3_get_array_value'] = [Void, [ContextObj, Model, Ast, CUInt, AstArray, AstArray, _ref2.default.refType(Ast)]];
GeneratedBindings['Z3_get_model_func_else'] = [Ast, [ContextObj, Model, CUInt]];
GeneratedBindings['Z3_get_model_func_num_entries'] = [CUInt, [ContextObj, Model, CUInt]];
GeneratedBindings['Z3_get_model_func_entry_num_args'] = [CUInt, [ContextObj, Model, CUInt, CUInt]];
GeneratedBindings['Z3_get_model_func_entry_arg'] = [Ast, [ContextObj, Model, CUInt, CUInt, CUInt]];
GeneratedBindings['Z3_get_model_func_entry_value'] = [Ast, [ContextObj, Model, CUInt, CUInt]];
GeneratedBindings['Z3_eval'] = [CInt, [ContextObj, Model, Ast, _ref2.default.refType(Ast)]];
GeneratedBindings['Z3_eval_decl'] = [CInt, [ContextObj, Model, FuncDecl, CUInt, AstArray, _ref2.default.refType(Ast)]];
GeneratedBindings['Z3_context_to_string'] = [CString, [ContextObj]];
GeneratedBindings['Z3_statistics_to_string'] = [CString, [ContextObj]];
GeneratedBindings['Z3_get_context_assignment'] = [Ast, [ContextObj]];
...
GeneratedBindings['Z3_rcf_get_numerator_denominator'] = [Void, [ContextObj, RCFNumObj, _ref2.default.refType(RCFNumObj), _ref2.default.refType(RCFNumObj)]];
...
GeneratedBindings['Z3_compute_interpolant'] = [CInt, [ContextObj, Ast, Params, _ref2.default.refType(AstVectorObj), _ref2.default.refType(Model)]];
GeneratedBindings['Z3_interpolation_profile'] = [CString, [ContextObj]];
GeneratedBindings['Z3_read_interpolation_problem'] = [CInt, [ContextObj, _ref2.default.refType(CUInt), Ast, CUInt, CString, _ref2.default.refType(CString), _ref2.default.refType(CUInt), Ast]];
GeneratedBindings['Z3_check_interpolant'] = [CInt, [ContextObj, CUInt, AstArray, CUIntArray, AstArray, _ref2.default.refType(CString), CUInt, AstArray]];
...
GeneratedBindings['Z3_fpa_get_numeral_sign'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CInt)]];
GeneratedBindings['Z3_fpa_get_numeral_significand_string'] = [CString, [ContextObj, Ast]];
GeneratedBindings['Z3_fpa_get_numeral_significand_uint64'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CULong)]];
GeneratedBindings['Z3_fpa_get_numeral_exponent_string'] = [CString, [ContextObj, Ast]];
GeneratedBindings['Z3_fpa_get_numeral_exponent_int64'] = [CInt, [ContextObj, Ast, _ref2.default.refType(CLong)]];
...
var Z3 = _ffi2.default.Library(libPath, GeneratedBindings);

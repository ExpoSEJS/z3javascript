...
GeneratedBindings['Z3_mk_tuple_sort'] = [Sort, [ContextObj, _Symbol, CUInt, SymbolArray, SortArray, ref.refType(FuncDecl), FuncDeclArray]];
GeneratedBindings['Z3_mk_enumeration_sort'] = [Sort, [ContextObj, _Symbol, CUInt, SymbolArray, FuncDeclArray, FuncDeclArray]];
GeneratedBindings['Z3_mk_list_sort'] = [Sort, [ContextObj, _Symbol, Sort, ref.refType(FuncDecl), ref.refType(FuncDecl), ref.refType(FuncDecl), ref.refType(FuncDecl), ref.refType(FuncDecl), ref.refType(FuncDecl)]];
...
GeneratedBindings['Z3_check_and_get_model'] = [CInt, [ContextObj, ref.refType(Model)]];
GeneratedBindings['Z3_check'] = [CInt, [ContextObj]];
GeneratedBindings['Z3_check_assumptions'] = [CInt, [ContextObj, CUInt, AstArray, ref.refType(Model), ref.refType(Ast), ref.refType(CUInt), AstArray]];
...
GeneratedBindings['Z3_eval_func_decl'] = [CInt, [ContextObj, Model, FuncDecl, ref.refType(Ast)]];
GeneratedBindings['Z3_is_array_value'] = [CInt, [ContextObj, Model, Ast, ref.refType(CUInt)]];
GeneratedBindings['Z3_get_array_value'] = [Void, [ContextObj, Model, Ast, CUInt, AstArray, AstArray, ref.refType(Ast)]];
...
GeneratedBindings['Z3_eval'] = [CInt, [ContextObj, Model, Ast, ref.refType(Ast)]];
GeneratedBindings['Z3_eval_decl'] = [CInt, [ContextObj, Model, FuncDecl, CUInt, AstArray, ref.refType(Ast)]];
